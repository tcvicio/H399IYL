...
public class mcreator_whiteRecord{

public mcreator_whiteRecord(){}

public static Item block;public static Object instance;public void load(FMLInitializationEvent event){
if(event.getSide() == Side.CLIENT)
Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(block, 0, new ModelResourceLocation("TestEnvironmentMod:WhiteRecord", "inventory"));

GameRegistry.addRecipe(new ItemStack(block, 1), new Object[]{
	"XXX", "X45", "XXX", Character.valueOf('4'), new ItemStack(mcreator_virginRecord.block, 1), Character.valueOf('5'), new ItemStack(Items.dye, 1, 15), 
});}
...
static{
block = (new ItemwhiteRecord(5640));

}

static class ItemwhiteRecord extends Item{

public ItemwhiteRecord(int par1){
setMaxDamage(0);
maxStackSize = 1;
setUnlocalizedName("WhiteRecord");
GameRegistry.registerItem(this, "WhiteRecord");
...
if(world.getBlockState(new BlockPos(i, j, k)) == mcreator_defqonOneSpeaker.block){
if(entity instanceof EntityPlayer)((EntityPlayer)entity).inventory.consumeInventoryItem(mcreator_whiteRecord.block);
}
