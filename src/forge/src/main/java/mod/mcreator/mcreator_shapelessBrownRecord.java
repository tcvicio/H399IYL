...
public class mcreator_shapelessBrownRecord{

public mcreator_shapelessBrownRecord(){}

public Object instance;public void load(FMLInitializationEvent event){
ItemStack recStack = new ItemStack(mcreator_brownRecord.block, 1);


GameRegistry.addShapelessRecipe(recStack, new Object[]{
new ItemStack(mcreator_virginRecord.block, 1), new ItemStack(Items.dye, 1, 3), 
});}
