...
public class mcreator_shapelessUVRecord{

public mcreator_shapelessUVRecord(){}

public Object instance;public void load(FMLInitializationEvent event){
ItemStack recStack = new ItemStack(mcreator_uvRecord.block, 1);


GameRegistry.addShapelessRecipe(recStack, new Object[]{
new ItemStack(Items.dye, 1, 5), new ItemStack(mcreator_virginRecord.block, 1), 
});}
