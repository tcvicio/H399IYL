...
public class mcreator_blueRecord{

public mcreator_blueRecord(){}

public static Item block;public static Object instance;public void load(FMLInitializationEvent event){
if(event.getSide() == Side.CLIENT)
Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(block, 0, new ModelResourceLocation("TestEnvironmentMod:BlueRecord", "inventory"));

GameRegistry.addRecipe(new ItemStack(block, 1), new Object[]{
	"XXX", "X45", "XXX", Character.valueOf('4'), new ItemStack(mcreator_virginRecord.block, 1), Character.valueOf('5'), new ItemStack(Items.dye, 1, 12), 
});}
...
static{
block = (new ItemblueRecord(5635));

}

static class ItemblueRecord extends Item{

public ItemblueRecord(int par1){
setMaxDamage(0);
maxStackSize = 1;
setUnlocalizedName("BlueRecord");
GameRegistry.registerItem(this, "BlueRecord");
...
{
list.add("§3§lRaw Hardstyle");
list.add("Gunz for Hire - The Dopeman");
}
