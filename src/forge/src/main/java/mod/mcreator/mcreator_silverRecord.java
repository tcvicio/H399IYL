...
public class mcreator_silverRecord{

public mcreator_silverRecord(){}

public static Item block;public static Object instance;public void load(FMLInitializationEvent event){
if(event.getSide() == Side.CLIENT)
Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(block, 0, new ModelResourceLocation("TestEnvironmentMod:SilverRecord", "inventory"));

GameRegistry.addRecipe(new ItemStack(block, 1), new Object[]{
	"XXX", "X45", "XXX", Character.valueOf('4'), new ItemStack(mcreator_virginRecord.block, 1), Character.valueOf('5'), new ItemStack(Items.dye, 1, 7), 
});}
...
static{
block = (new ItemsilverRecord(5645));

}

static class ItemsilverRecord extends Item{

public ItemsilverRecord(int par1){
setMaxDamage(0);
maxStackSize = 1;
setUnlocalizedName("SilverRecord");
GameRegistry.registerItem(this, "SilverRecord");
...
if(world.getBlockState(new BlockPos(i, j, k)) == mcreator_defqonOneSpeaker.block){
if(entity instanceof EntityPlayer)((EntityPlayer)entity).inventory.consumeInventoryItem(mcreator_silverRecord.block);
}
