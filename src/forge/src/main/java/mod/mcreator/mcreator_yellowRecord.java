...
public class mcreator_yellowRecord{

public mcreator_yellowRecord(){}

public static Item block;public static Object instance;public void load(FMLInitializationEvent event){
if(event.getSide() == Side.CLIENT)
Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(block, 0, new ModelResourceLocation("TestEnvironmentMod:YellowRecord", "inventory"));

GameRegistry.addRecipe(new ItemStack(block, 1), new Object[]{
	"X1X", "X4X", "XXX", Character.valueOf('1'), new ItemStack(Items.dye, 1, 11), Character.valueOf('4'), new ItemStack(mcreator_virginRecord.block, 1), 
});}
...
static{
block = (new ItemyellowRecord(5633));

}

static class ItemyellowRecord extends Item{

public ItemyellowRecord(int par1){
setMaxDamage(0);
maxStackSize = 1;
setUnlocalizedName("YellowRecord");
GameRegistry.registerItem(this, "YellowRecord");
...
if(world.getBlockState(new BlockPos(i, j, k)) == mcreator_defqonOneSpeaker.block){
if(entity instanceof EntityPlayer)((EntityPlayer)entity).inventory.consumeInventoryItem(mcreator_yellowRecord.block);
}
