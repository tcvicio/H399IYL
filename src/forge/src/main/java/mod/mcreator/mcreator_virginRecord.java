...
public class mcreator_virginRecord{

public mcreator_virginRecord(){}
...
static{
block = (new ItemvirginRecord(5634));

}

static class ItemvirginRecord extends Item{

public ItemvirginRecord(int par1){
setMaxDamage(0);
maxStackSize = 64;
setUnlocalizedName("VirginRecord");
GameRegistry.registerItem(this, "VirginRecord");
...
{
list.add("Base to craft H399IYL Defqon.1 Records");
}
