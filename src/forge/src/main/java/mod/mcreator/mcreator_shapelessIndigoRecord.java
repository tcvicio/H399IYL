...
public class mcreator_shapelessIndigoRecord{

public mcreator_shapelessIndigoRecord(){}

public Object instance;public void load(FMLInitializationEvent event){
ItemStack recStack = new ItemStack(mcreator_indigoRecord.block, 1);


GameRegistry.addShapelessRecipe(recStack, new Object[]{
new ItemStack(mcreator_virginRecord.block, 1), new ItemStack(Items.dye, 1, 4), 
});}
