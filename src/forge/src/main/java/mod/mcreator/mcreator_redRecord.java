...
public class mcreator_redRecord{

public mcreator_redRecord(){}

public static Item block;public static Object instance;public void load(FMLInitializationEvent event){
if(event.getSide() == Side.CLIENT)
Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(block, 0, new ModelResourceLocation("TestEnvironmentMod:RedRecord", "inventory"));

GameRegistry.addRecipe(new ItemStack(block, 1), new Object[]{
	"XXX", "X45", "XXX", Character.valueOf('4'), new ItemStack(mcreator_virginRecord.block, 1), Character.valueOf('5'), new ItemStack(Items.dye, 1, 1), 
});}
...
static{
block = (new ItemredRecord(5636));

}

static class ItemredRecord extends Item{

public ItemredRecord(int par1){
setMaxDamage(0);
maxStackSize = 1;
setUnlocalizedName("RedRecord");
GameRegistry.registerItem(this, "RedRecord");
...
if(world.getBlockState(new BlockPos(i, j, k)) == mcreator_defqonOneSpeaker.block){
if(entity instanceof EntityPlayer)((EntityPlayer)entity).inventory.consumeInventoryItem(mcreator_redRecord.block);
}
...
list.add("Francezco Zeta - Reverse Bass");
