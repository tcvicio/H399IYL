...
public class mcreator_shapelessGoldRecord{

public mcreator_shapelessGoldRecord(){}

public Object instance;public void load(FMLInitializationEvent event){
ItemStack recStack = new ItemStack(mcreator_goldRecord.block, 1);


GameRegistry.addShapelessRecipe(recStack, new Object[]{
new ItemStack(Items.gold_nugget, 1), new ItemStack(mcreator_virginRecord.block, 1), 
});}
