...
public class mcreator_brownRecord{

public mcreator_brownRecord(){}

public static Item block;public static Object instance;public void load(FMLInitializationEvent event){
if(event.getSide() == Side.CLIENT)
Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(block, 0, new ModelResourceLocation("TestEnvironmentMod:BrownRecord", "inventory"));

GameRegistry.addRecipe(new ItemStack(block, 1), new Object[]{
	"XXX", "X45", "XXX", Character.valueOf('4'), new ItemStack(mcreator_virginRecord.block, 1), Character.valueOf('5'), new ItemStack(Items.dye, 1, 3), 
});}
...
static{
block = (new ItembrownRecord(5642));

}

static class ItembrownRecord extends Item{

public ItembrownRecord(int par1){
setMaxDamage(0);
maxStackSize = 1;
setUnlocalizedName("BrownRecord");
GameRegistry.registerItem(this, "BrownRecord");
