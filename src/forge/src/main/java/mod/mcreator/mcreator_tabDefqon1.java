...
public class mcreator_tabDefqon1 {

public Object instance;

public static CreativeTabs tab = new CreativeTabs("tabtabDefqon1") {
                @SideOnly(Side.CLIENT)
                public Item getTabIconItem(){
                        return Item.getItemFromBlock(mcreator_defqonOneSpeaker.block);
                }
        };

public mcreator_tabDefqon1(){}
