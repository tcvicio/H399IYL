...
public class mcreator_hacheTab {

public Object instance;

public static CreativeTabs tab = new CreativeTabs("tabhacheTab") {
                @SideOnly(Side.CLIENT)
                public Item getTabIconItem(){
                        return Item.getItemFromBlock(mcreator_hacheOre.block);
                }
        };

public mcreator_hacheTab(){}
