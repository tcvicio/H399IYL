...
public class mcreator_nightmareDimension {
...
portal = (BlockTutorialPortal)(new BlockTutorialPortal().setUnlocalizedName("nightmareDimension_portal"));
block = (ModTrigger)(new ModTrigger().setUnlocalizedName("nightmareDimension_trigger")/*.setTextureName("AlienChip")*/);
//Item.itemRegistry.addObject(5657, "nightmareDimension_trigger", block);
}

public mcreator_nightmareDimension(){}

public void load(FMLInitializationEvent event){
GameRegistry.registerBlock(portal, "nightmareDimension_portal");
GameRegistry.registerItem(block, "nightmareDimension_trigger");
DimensionManager.registerProviderType(DIMID, mcreator_nightmareDimension.WorldProviderMod.class, false);
DimensionManager.registerDimension(DIMID, DIMID);

if(event.getSide() == Side.CLIENT)
Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(block, 0, new ModelResourceLocation("TestEnvironmentMod:nightmareDimension_trigger", "inventory"));
...
public static class WorldProviderMod extends WorldProvider{
    ...
    public IChunkProvider createChunkGenerator(){
        return new ChunkProviderModded(this.worldObj, this.worldObj.getSeed()-18913);
    }
            ...
            for (int l = -2; l <= 2; ++l)
            {
                for (int i1 = -2; i1 <= 2; ++i1)
                {
                    for (int j1 = -1; j1 < 3; ++j1)
                    {
                        ...
                        int i2 = k + i1 * b1 - l * b0;
                        boolean flag = j1 < 0;
                        this.worldServerInstance.setBlockState(new BlockPos(k1, l1, i2), flag ? Blocks.mossy_cobblestone.getDefaultState() : Blocks.air.getDefaultState());
                    }
                }
            }
            ...
            for (i3 = -1; i3 <= 1; ++i3)
            {
                for (j3 = 1; j3 < 3; ++j3)
                {
                    for (k3 = -1; k3 < 3; ++k3)
                    {
                        ...
                        j4 = k2 + (j3 - 1) * l2 - i3 * l5;
                        boolean flag = k3 < 0;
                        this.worldServerInstance.setBlockState(new BlockPos(l3, i4, j4), flag ? Blocks.mossy_cobblestone.getDefaultState() : Blocks.air.getDefaultState());
                    }
                }
            }
        }
        ...
        for (j3 = 0; j3 < 4; ++j3)
        {
            for (k3 = 0; k3 < 4; ++k3)
            {
                for (l3 = -1; l3 < 4; ++l3)
                {
                    ...
                    this.worldServerInstance.setBlockState(new BlockPos(i4, j4, k4), flag1 ? Blocks.mossy_cobblestone.getDefaultState() : iblockstate, 2);
                }
            }
...
byte b0 = 0;
byte b1 = 0;
if (getBlock(par1World,par2 - 1, par3, par4) == Blocks.mossy_cobblestone || getBlock(par1World,par2 + 1, par3, par4) == Blocks.mossy_cobblestone)
{
b0 = 1;
}
if (getBlock(par1World,par2, par3, par4 - 1) == Blocks.mossy_cobblestone || getBlock(par1World,par2, par3, par4 + 1) == Blocks.mossy_cobblestone)
{
b1 = 1;
}
if (b0 == b1)
...
if (getBlock(par1World,par2, i1 - 1, par4) != Blocks.mossy_cobblestone)
{
...
if (j1 == 3 && getBlock(par1World,par2, i1 + j1, par4) == Blocks.mossy_cobblestone)
{
...
{
         if ((getBlock(par1World,par2 + b0, par3, par4 + b1) != Blocks.mossy_cobblestone || getBlock(par1World,par2 - b0, par3, par4 - b1) != this) && (getBlock(par1World,par2 - b0, par3, par4 - b1) != Blocks.mossy_cobblestone || getBlock(par1World,par2 + b0, par3, par4 + b1) != this))
         {
         par1World.setBlockToAir(new BlockPos(par2, par3, par4));
         }
}
	...
	public void func_180519_a(ChunkPrimer p_180519_1_)
    {
        ...
        for (int i = 0; i < 16; ++i)
        {
            for (int j = 0; j < 16; ++j)
            {
                byte b0 = 1;
                int k = -1;
                IBlockState iblockstate = Blocks.coal_block.getDefaultState();
                IBlockState iblockstate1 = Blocks.coal_block.getDefaultState();
                    ...
                    else if (iblockstate2.getBlock() == Blocks.stone)
                    {
                        if (k == -1)
                        {
                            if (b0 <= 0)
                            {
                                ...
                                iblockstate1 = Blocks.coal_block.getDefaultState();
                            }
                    ...
                    for (int l1 = 0; l1 < 4; ++l1)
                    {
                        ...
                        for (int i2 = 0; i2 < 8; ++i2)
                        {
                            ...
                            for (int j2 = 0; j2 < 8; ++j2)
                            {
                                ...
                                if (d15 > 0.0D)
                                {
                                    iblockstate = Blocks.coal_block.getDefaultState();
                                }
