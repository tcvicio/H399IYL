...
public class mcreator_goldRecord{

public mcreator_goldRecord(){}

public static Item block;public static Object instance;public void load(FMLInitializationEvent event){
if(event.getSide() == Side.CLIENT)
Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(block, 0, new ModelResourceLocation("TestEnvironmentMod:GoldRecord", "inventory"));

GameRegistry.addRecipe(new ItemStack(block, 1), new Object[]{
	"XXX", "X45", "XXX", Character.valueOf('4'), new ItemStack(mcreator_virginRecord.block, 1), Character.valueOf('5'), new ItemStack(Items.gold_nugget, 1), 
});}
...
static{
block = (new ItemgoldRecord(5639));

}

static class ItemgoldRecord extends Item{

public ItemgoldRecord(int par1){
setMaxDamage(0);
maxStackSize = 1;
setUnlocalizedName("GoldRecord");
GameRegistry.registerItem(this, "GoldRecord");
...
if(world.getBlockState(new BlockPos(i, j, k)) == mcreator_defqonOneSpeaker.block){
if(entity instanceof EntityPlayer)((EntityPlayer)entity).inventory.consumeInventoryItem(mcreator_goldRecord.block);
}
