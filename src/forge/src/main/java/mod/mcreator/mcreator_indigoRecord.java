...
public class mcreator_indigoRecord{

public mcreator_indigoRecord(){}

public static Item block;public static Object instance;public void load(FMLInitializationEvent event){
if(event.getSide() == Side.CLIENT)
Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(block, 0, new ModelResourceLocation("TestEnvironmentMod:IndigoRecord", "inventory"));

GameRegistry.addRecipe(new ItemStack(block, 1), new Object[]{
	"XXX", "X45", "XXX", Character.valueOf('4'), new ItemStack(mcreator_virginRecord.block, 1), Character.valueOf('5'), new ItemStack(Items.dye, 1, 4), 
});}
...
static{
block = (new ItemindigoRecord(5646));

}

static class ItemindigoRecord extends Item{

public ItemindigoRecord(int par1){
setMaxDamage(0);
maxStackSize = 1;
setUnlocalizedName("IndigoRecord");
GameRegistry.registerItem(this, "IndigoRecord");
...
if(world.getBlockState(new BlockPos(i, j, k)) == mcreator_defqonOneSpeaker.block){
if(entity instanceof EntityPlayer)((EntityPlayer)entity).inventory.consumeInventoryItem(mcreator_indigoRecord.block);
}
