...
public class mcreator_uvRecord{

public mcreator_uvRecord(){}

public static Item block;public static Object instance;public void load(FMLInitializationEvent event){
if(event.getSide() == Side.CLIENT)
Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(block, 0, new ModelResourceLocation("TestEnvironmentMod:UvRecord", "inventory"));

GameRegistry.addRecipe(new ItemStack(block, 1), new Object[]{
	"XXX", "X45", "XXX", Character.valueOf('4'), new ItemStack(mcreator_virginRecord.block, 1), Character.valueOf('5'), new ItemStack(Items.dye, 1, 5), 
});}
...
static{
block = (new ItemuvRecord(5643));

}

static class ItemuvRecord extends Item{

public ItemuvRecord(int par1){
setMaxDamage(0);
maxStackSize = 1;
setUnlocalizedName("UvRecord");
GameRegistry.registerItem(this, "UvRecord");
...
if(world.getBlockState(new BlockPos(i, j, k)) == mcreator_defqonOneSpeaker.block){
if(entity instanceof EntityPlayer)((EntityPlayer)entity).inventory.consumeInventoryItem(mcreator_uvRecord.block);
}
