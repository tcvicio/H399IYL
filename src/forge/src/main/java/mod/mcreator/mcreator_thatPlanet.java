...
public class mcreator_thatPlanet {
...
portal = (BlockTutorialPortal)(new BlockTutorialPortal().setUnlocalizedName("thatPlanet_portal"));
block = (ModTrigger)(new ModTrigger().setUnlocalizedName("thatPlanet_trigger")/*.setTextureName("PortalActivator")*/);
//Item.itemRegistry.addObject(5664, "thatPlanet_trigger", block);
}

public mcreator_thatPlanet(){}

public void load(FMLInitializationEvent event){
GameRegistry.registerBlock(portal, "thatPlanet_portal");
GameRegistry.registerItem(block, "thatPlanet_trigger");
DimensionManager.registerProviderType(DIMID, mcreator_thatPlanet.WorldProviderMod.class, false);
DimensionManager.registerDimension(DIMID, DIMID);

if(event.getSide() == Side.CLIENT)
Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(block, 0, new ModelResourceLocation("TestEnvironmentMod:thatPlanet_trigger", "inventory"));


GameRegistry.addRecipe(new ItemStack(block, 1), new Object[]{
	"012", "X4X", "X7X", Character.valueOf('0'), new ItemStack(Blocks.redstone_torch, 1), Character.valueOf('1'), new ItemStack(Items.blaze_rod, 1), Character.valueOf('2'), new ItemStack(Blocks.redstone_torch, 1), Character.valueOf('4'), new ItemStack(Items.nether_star, 1), Character.valueOf('7'), new ItemStack(mcreator_alienChip.block, 1), 
});
            ...
            for (int l = -2; l <= 2; ++l)
            {
                for (int i1 = -2; i1 <= 2; ++i1)
                {
                    for (int j1 = -1; j1 < 3; ++j1)
                    {
                        ...
                        int i2 = k + i1 * b1 - l * b0;
                        boolean flag = j1 < 0;
                        this.worldServerInstance.setBlockState(new BlockPos(k1, l1, i2), flag ? mcreator_interspaceTransmitter.block.getDefaultState() : Blocks.air.getDefaultState());
                    }
                }
            }
            ...
            for (i3 = -1; i3 <= 1; ++i3)
            {
                for (j3 = 1; j3 < 3; ++j3)
                {
                    for (k3 = -1; k3 < 3; ++k3)
                    {
                        ...
                        j4 = k2 + (j3 - 1) * l2 - i3 * l5;
                        boolean flag = k3 < 0;
                        this.worldServerInstance.setBlockState(new BlockPos(l3, i4, j4), flag ? mcreator_interspaceTransmitter.block.getDefaultState() : Blocks.air.getDefaultState());
                    }
                }
            }
        }
        ...
        for (j3 = 0; j3 < 4; ++j3)
        {
            for (k3 = 0; k3 < 4; ++k3)
            {
                for (l3 = -1; l3 < 4; ++l3)
                {
                    ...
                    this.worldServerInstance.setBlockState(new BlockPos(i4, j4, k4), flag1 ? mcreator_interspaceTransmitter.block.getDefaultState() : iblockstate, 2);
                }
            }
...
byte b0 = 0;
byte b1 = 0;
if (getBlock(par1World,par2 - 1, par3, par4) == mcreator_interspaceTransmitter.block || getBlock(par1World,par2 + 1, par3, par4) == mcreator_interspaceTransmitter.block)
{
b0 = 1;
}
if (getBlock(par1World,par2, par3, par4 - 1) == mcreator_interspaceTransmitter.block || getBlock(par1World,par2, par3, par4 + 1) == mcreator_interspaceTransmitter.block)
{
b1 = 1;
}
if (b0 == b1)
...
for (i1 = -1; i1 <= 3; ++i1)
{
         ...
         if (flag)
         {
         if (j1 != mcreator_interspaceTransmitter.block)
         {
         return false;
         }
         }
...
if (getBlock(par1World,par2, i1 - 1, par4) != mcreator_interspaceTransmitter.block)
{
...
if (j1 == 3 && getBlock(par1World,par2, i1 + j1, par4) == mcreator_interspaceTransmitter.block)
{
...
{
         if ((getBlock(par1World,par2 + b0, par3, par4 + b1) != mcreator_interspaceTransmitter.block || getBlock(par1World,par2 - b0, par3, par4 - b1) != this) && (getBlock(par1World,par2 - b0, par3, par4 - b1) != mcreator_interspaceTransmitter.block || getBlock(par1World,par2 + b0, par3, par4 + b1) != this))
         {
         par1World.setBlockToAir(new BlockPos(par2, par3, par4));
         }
}
...
public static class ChunkProviderModded implements IChunkProvider
{
	...
	public boolean func_177460_a(IChunkProvider p_177460_1_, Chunk p_177460_2_, int p_177460_3_, int p_177460_4_)
    {
        ...
        /*if ( this.mapFeaturesEnabled && p_177460_2_.getInhabitedTime() < 3600L)
        {
            ...
            flag |= this.oceanMonumentGenerator.func_175788_a(new ChunkCoordIntPair(p_177460_3_, p_177460_4_));
        }*/
